...
(function (factory) {
  ...
  var settings = {
    ...
    options: {
      ...
      toolbar: [
        ...
        ['height', ['height']],
        ['table', ['table']],
        ['insert', ['link', 'picture', 'video', 'smilies']],
  ...
  var Editor = function () {
    ...
    var aCmd = ['bold', 'italic', 'underline', 'strikethrough',
                ...
                'backColor', 'foreColor', 'insertHorizontalRule', 'fontName', 'addSmilie'];
  ...
  var Renderer = function () {
    ...
    tplToolbarInfo = {
      ...
      fontname: function(lang) {
        var aFont = [{n:'宋体',c:'SimSun'},{n:'仿宋体',c:'FangSong_GB2312'},{n:'黑体',c:'SimHei'},{n:'楷体',c:'KaiTi_GB2312'},{n:'微软雅黑',c:'Microsoft YaHei'},{n:'Arial'},{n:'Arial Black'},{n:'Comic Sans MS'},{n:'Courier New'},{n:'System'},{n:'Times New Roman'},{n:'Tahoma'},{n:'Verdana'}]/*[
          'Serif', 'Sans', 'Arial', 'Arial Black', 'Courier',
          'Courier New', 'Comic Sans MS', 'Helvetica', 'Impact', 'Lucida Grande',
          'Lucida Sans', 'Tahoma', 'Times', 'Times New Roman', 'Verdana'
        ]*/;

        var sMarkup = '<button type="button" class="btn btn-default btn-sm btn-small dropdown-toggle" data-toggle="dropdown" title="' + lang.font.name + '" tabindex="-1"><span class="note-current-fontname">SimSun</span> <b class="caret"></b></button>';
        ...
        for (var idx = 0; idx < aFont.length; idx++ ) {
          ...
          sMarkup += '<li><a data-event="fontName" data-value="' + (aFont[idx].c||aFont[idx].n) + '"><i class="fa fa-check icon-ok"></i> ' + aFont[idx].n + '</a></li>';
        }
        sMarkup += '</ul>';
      ...
      smilies: function(locale) {
        if (!window.emotionPath) return '';
        return '<button type="button" class="btn btn-default btn-sm btn-small note-recent-color" title="' + locale.color.recent + '" data-event="color" data-value=\'{"backColor":"yellow"}\' tabindex="-1"><i class="fa fa-smile-o" style="color:black"></i></button>' +
          '<button type="button" class="btn btn-default btn-sm btn-small dropdown-toggle" title="更多表情" data-toggle="dropdown" tabindex="-1">' +
          '<span class="caret"></span>' +
          '</button>' +
          '<ul class="dropdown-menu" style="padding-top:0">' +
          '<li>' +
          '<ul class="smiliedropdown" style="list-style:none;width:160px;padding:10px">' +
          (function(list){
          var ls = '';
          for(var i in list){
          ls += '<li style="float:left"><a data-event="addSmilie" style="display:inline-block;width:24px;height:24px;margin:2px" data-value="'+window.emotionPath+'/'+list[i]+'.gif"><img style="width:100%;height:100%" src="'+window.emotionPath+'/'+list[i]+'.gif"></a></li>';
          }
          return ls;
          })(['smile','tongue','titter','laugh','sad','wronged','fastcry','cry','wail','mad','knock','curse','crazy','angry','ohmy','awkward','panic','shy','cute','envy','proud','struggle','quiet','shutup','doubt','despise','sleep','bye','location','bus','plain','traffic','speedboat','dot','emu','helicopters']) +
          '</ul>' +
  ...
  $.fn.extend({
    ...
    summernote: function (options) {
      ...
      window.emotionPath = options.emotionPath;
